...
::: warning Android Wear OS 5
Installing the AAPS Watch Face has to be done with [Wear Installer 2](https://www.youtube.com/watch?v=yef_qGvcCnk) after installing the Wear app.<br/> Accidental change of the Watch Face to another one requires the procedure above to be repeated.<br/> Changing the dedicated Watch Face parameters like: Dark, Watchdivider, etc. is not possible.<br/><br/> **FIRMWARE UPDATES WILL MOST PROBABLY BREAK AAPS WATCHFACES: DISABLE WATCH UPDATES**.
:::
...
::: tip
For Wear OS 5 watches follow [this video](https://www.youtube.com/watch?v=yef_qGvcCnk). See troubleshooting tips [below](#BuildingAapsWearOs-WearOS5-TShoot).
:::
