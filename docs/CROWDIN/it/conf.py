...
html_context = {
  ...
  'github_version': 'master/docs/CROWDIN/it/',
}
...
language = "it"
myst_html_meta = {
  'title': 'Documentazione AAPS',
  'subtitle': 'Documentazione AndroidAPS',
  'short_title': 'Documentazione AAPS',
  'description': 'Android APS (AAPS) è un app open source per persone che vivono con il diabete insulino-dipendente di tipo 1. E un sistema pancreas artificiale (APS) che funziona con telefonini Android.',
