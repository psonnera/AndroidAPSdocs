...
I trasmettitori Bluetooth possono essere utilizzati con il Libre 2 (EU) o 2+ (EU) e un'app con un algoritmo esterno (OOP). È possibile ricevere i valori della glicemia ogni 5 minuti come con il [Libre 1](./Libre1.md).
...
![Calibrazione OOP2](../images/cgm/xDrip+/Libre2_OOP2Calibration.png)
...
![sorgente xDrip+ BG](../images/Configuration-Builder/ConfBuild_BG_xDrip.png)
...
xDrip+ doesn't support direct connection to Libre 2 US and AUS. Only Libre 2 and 2+ **EU** models.
:::
...
![xDrip+ impostazioni avanzate Libre 2 & valori grezzi](../images/cgm/xDrip+/xDrip_Libre3_Smooth.png)
...
![xDrip+ impostazioni avanzate Libre 2 & valori grezzi](../images/cgm/xDrip+/Libre2_RawValues.png)
...
- Installa [Diabox](https://www.bubblesmartreader.com/_files/ugd/6afd37_f183eabd4fbd44fcac4b1926a79b094f.pdf). Nelle Impostazioni, Integrazione, abilita Condividi i dati con altre applicazioni.
