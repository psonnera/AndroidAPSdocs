...
<a id="setup-wizard-bluetooth-battery-optimisation"></a>
...
<a id="SetupWizard-StoragePermission"></a>
...
::: tip
Choosing the default AAPS directory is recommended.</br> Do **not** select a subdirectory of AAPS.
:::
...
<a id="SetupWizard-synchronization-with-the-reporting-server-and-more"></a>
...
::: danger Don't use the "Free-Peak Oref" unless you know what you are doing
...
::: danger Working profile required - no exceptions here !
...
::: info Profile only for tutorial - not for your usage
...
::: info Several defined but only one active profile
...
::: info Only use the older algorithm **OpenAPS AMA** if you know what you are doing
