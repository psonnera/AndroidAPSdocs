...
È possibile verificarlo nella scheda **DASH**: il campo **Pod scade: (1)** mostrerà l'ora esatta di scadenza del pod (72 ore dopo l'attivazione) e il testo diventerà **rosso** dopo che questo tempo è trascorso. Sotto il campo **Avvisi pod attivi (2)** viene visualizzato il messaggio di stato **Il pod scadrà presto**. Questo attiverà anche la visualizzazione del pulsante **SILENZIA AVVISI (3)**. If this box is left unchecked, you’ll find the DASH tab in the hamburger menu upper left.
...
3. Fare clic sul pulsante **Avanti**. Sullo schermo apparirà un segno di spunta verde e il pulsante **Avanti** diventerà disponibile dopo un inserimento riuscito della cannula.
...
8. Nella schermata **Inizializza Pod**, il pod inizierà l'innesco (si sentirà un clic seguito da una serie di ticchettii mentre il pod si innescha da solo). Quando l'innesco è riuscito apparirà un segno di spunta verde e il pulsante **Avanti** diventerà disponibile.
...
1. **AAPS** invia il comando al pod per disattivare i segnali acustici di avviso di scadenza del pod e aggiorna il campo **Stato pod (1)** con **CONFERMA AVVISI**. Andare alla scheda **DASH** e premere il pulsante **SILENZIA AVVISI (2)**.

   ![ACK_alerts_1](../images/DASH_images/ACK_Alerts/ACK_ALERTS_1.png)

2. Selezionare questa casella faciliterà l'accesso ai comandi DASH durante l'utilizzo di **AAPS**. Selezionando la **casella di controllo (4)** accanto all'**Ingranaggio Impostazioni (3)** si consente la visualizzazione del menu DASH come scheda nell'interfaccia **AAPS** con il titolo **DASH**.
...
Se questa casella è lasciata deselezionata, troverai la scheda DASH nel menu hamburger in alto a sinistra. Per verificare di aver selezionato il DASH in **AAPS**, se hai **selezionato la casella (4)**, **scorri verso sinistra** dalla scheda **Panoramica** e vedrai ora una scheda **DASH** in **AAPS**.
...
- Impossibile verificare se il bolo **SMB** è riuscito. Se si è sicuri che il Bolo non sia riuscito, eliminare manualmente la voce SMB dai Trattamenti. Avviso che il successo del comando bolo **SMB** non può essere verificato; sarà necessario verificare il campo *Ultimo bolo* nella scheda DASH per vedere se il bolo **SMB** è riuscito e, in caso contrario, rimuovere la voce dalla scheda Trattamenti.
