...
La procedura dettagliata di configurazione del dispositivo di comunicazione con il pod è riportata di seguito nella [sezione Configurazione RileyLink](#rileylink-setup).
