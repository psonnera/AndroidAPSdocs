...
## MEDTRONIC (MDT) Tab
![MDT Tab](../images/pump/medtronic/Medtronic02.png) When AAPS is configured to use a Medtronic pump a MDT tab will be shown in the list of tabs at the top of the screen.  This tab displays the current pump status information along with some Medtronic specific actions.
...
![RileyLink Status - Settings](../images/pump/medtronic/Medtronic04.png) ![RileyLink Status - History](../images/pump/medtronic/Medtronic05.png)
