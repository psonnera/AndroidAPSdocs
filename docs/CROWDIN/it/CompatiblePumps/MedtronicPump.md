...
Quando AAPS è configurato per utilizzare un microinfusore Medtronic, verrà mostrata una scheda MDT nell'elenco delle schede in cima allo schermo. Questa scheda mostra le informazioni sullo stato corrente del microinfusore insieme ad alcune azioni specifiche di Medtronic.
...
### Registrazione
Nel caso in cui sia necessario risolvere i problemi del microinfusore Medtronic, selezionare l'icona del menu nell'angolo in alto a sinistra dello schermo, selezionare Manutenzione e Impostazioni di registrazione. Per la risoluzione dei problemi Medtronic, è necessario selezionare Microinfusore, PumpComm, PumpBTComm.

### Medtronic CGM
Il CGM Medtronic NON è attualmente supportato.

### Uso manuale del microinfusore
