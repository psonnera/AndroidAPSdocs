...
![settings.png](../images/pump/Equil/settings.png)

### Activate patch

Navigate to the Equil Tab and press **Pair Equil Patch Pump**.

![overview.png](../images/pump/Equil/overview.png)

![activate1.png](../images/pump/Equil/activate1.png)

![activate2.png](../images/pump/Equil/activate2.png)

![activate3.png](../images/pump/Equil/activate3.png)
