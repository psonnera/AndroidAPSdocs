...
| `"dynValue"`*  | boolean | for example                                                                                                                                                                                                                                                                                                                                                         | | `"dynValue"`*  | boolean | true if you want to include raw value in (double). Usefull with `texvalue` key if you want a dedicated format to show value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | |
