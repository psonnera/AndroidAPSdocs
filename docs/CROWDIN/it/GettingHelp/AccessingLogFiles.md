...
* Locate the log files in the AAPS data directory, in `Android\data\info.nightscout.androidaps\files`.<br/> The naming of the root storage folder may vary a little depending on the phone.
