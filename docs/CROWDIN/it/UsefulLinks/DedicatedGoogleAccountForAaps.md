...
<details>
<summary>Advantages of a dedicated Google account for AAPS</summary>
...
<details>
<summary>Things to consider when setting up your new account</summary>
...
Complimenti! Now you have created an AAPS-dedicated Google account. The next step is to [build the AAPS app](../SettingUpAaps/BuildingAaps.md).