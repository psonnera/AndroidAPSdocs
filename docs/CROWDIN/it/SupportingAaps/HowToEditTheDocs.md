...
4. Hai lavorato nella scheda "<>Modifica file". Se vedi un miglioramento necessario, torna alla scheda di modifica per apportare ulteriori miglioramenti. Seleziona la scheda "Anteprima modifiche" per un aggiornamento e assicurati che tutto ciò che hai modificato sembri come intendevi (errori di battitura inclusi).
