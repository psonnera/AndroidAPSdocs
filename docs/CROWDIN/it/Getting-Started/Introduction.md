...
Lo smartphone **Android** avrà anche bisogno di avere un'altra app installata in più di **AAPS**. This [additional app](./CompatibleCgms.md) receives glucose data from a sensor (**2**) by bluetooth, and then sends the data internally on the phone to the **AAPS app**.
