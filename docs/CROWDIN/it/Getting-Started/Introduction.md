...
Sono stati rilasciati diversi sistemi commerciali a circuito chiuso ibrido, i più recenti sono [CamAPS FX](https://camdiab.com/) (UK e UE) e [Omnipod 5](https://www.omnipod.com/en-gb/what-is-omnipod/omnipod-5) (USA e UE). Questi sistemi sono molto diversi dai sistemi OS-AID, principalmente perché includono entrambi un "algoritmo di apprendimento" che regola la quantità di insulina erogata in base alle esigenze di insulina dei giorni precedenti. Molte persone della comunità OS-AID hanno già provato questi sistemi commerciali e li hanno confrontati con il proprio sistema OS-AID. È possibile scoprire di più su come i diversi sistemi si confrontano chiedendo sui gruppi Facebook dedicati per questi sistemi, sul gruppo [AAPS Facebook](https://www.facebook.com/groups/AndroidAPSUsers/) o su [Discord](https://discord.com/invite/4fQUWHZ4Mw).
...
Poiché OpenAPS è compatibile solo con alcun microinfusore per insulina più vecchi, Nel 2016 Milos Kozak ha sviluppato **AAPS** (che può essere utilizzato con una gamma più ampia di micro) per un familiare con diabete di tipo 1. Da quei primi giorni, **AAPS** è stato continuamente sviluppato e raffinato da un team di sviluppatori volontari e altri appassionati che hanno una connessione al mondo del diabete di tipo 1. I componenti fondamentali del sistema attuale **AAPS** sono descritti nella figura **Figura 1** di cui sopra. È un sistema altamente personalizzabile e versatile e, poiché è open-source, è facilmente compatibile con molti altri software e piattaforme open-source per il diabete. Oggi **AAPS** è utilizzato da circa 20.000 persone.
...
#### 5) **Telecomando**
Un vantaggio significativo di **AAPS** rispetto ai sistemi commerciali è che è possibile per i follower di utilizzare degli SMS autenticati o un'app ([Nightscout](https://nightscout.github.io/) o AAPSClient) per inviare diversi comandi remoti al sistema **AAPS**. Questo è ampiamente utilizzato dai genitori di bambini con diabete di tipo 1 che usano AAPS. È molto utile: per esempio, al parco giochi, se vuoi fare un pre-bolo per uno spuntino dal tuo telefono, mentre tuo figlio è impegnato a giocare. Man mano che l'autonomia delle batterie degli orologi migliora e la tecnologia diventa più stabile, questa ultima opzione diventerà sempre più interessante. È possibile monitorare il sistema (_ad es._ Fitbit), inviare comandi di base (_ad es._ Samsung Galaxy watch 4), o anche eseguire l'intero sistema AAPS da uno smartwatch di alto livello (**5**) (_ad es._ LEMFO). In quest'ultimo scenario, non hai bisogno di usare un telefono per eseguire AAPS.

#### 6) **Nessun vincolo commerciale, grazie alle interfacce applicative aperte**
Oltre all'approccio open-source, che consente di visualizzare il codice sorgente di **AAPS** in qualsiasi momento, il principio generale di fornire interfacce di programmazione aperte offre anche ad altri sviluppatori l'opportunità di contribuire con nuove idee. **AAPS** è strettamente integrato con Nightscout. Questo accelera lo sviluppo e consente agli utenti di aggiungere funzionalità per rendere la vita con il diabete ancora più comoda. Buoni esempi di tali integrazioni sono [Nightscout](https://nightscout.github.io/), [Nightscout Reporter](https://nightscout-reporter.zreptil.de/), xDrip+, [M5 stack](https://github.com/mlukasek/M5_NightscoutMon/wiki) ecc. Vi è un dialogo continuo tra gli sviluppatori open-source e coloro che sviluppano sistemi commerciali. There is ongoing dialogue between open-source developers and those developing commercial systems. Molte delle innovazioni DIY vengono gradualmente adottate dai sistemi commerciali, dove gli sviluppi sono comprensibilmente più lenti, in parte perché le interfacce tra sistemi di diverse aziende (micro, app, sensori _ecc._) devono essere attentamente negoziate e concesse in licenza. Questo può anche rallentare le innovazioni che sono comode per il paziente (o una piccola sottopopolazione di pazienti con un requisito molto specifico) ma non generano un profitto significativo.
...
a) Il sistema **AAPS** è stato progettato DA pazienti e dai loro assistenti. È stato progettato principalmente per la sicurezza, ma anche attingendo all'esperienza approfondita dei pazienti. Ci sono attualmente circa **20.000** utenti AAPS in tutto il mondo. Pertanto, è probabile che ci siano altri pazienti che utilizzano il loop DIY nella popolazione di pazienti della tua clinica (che ne siano a conoscenza o meno).
