...
Sono stati rilasciati diversi sistemi commerciali a circuito chiuso ibrido, i più recenti sono [CamAPS FX](https://camdiab.com/) (UK e UE) e [Omnipod 5](https://www.omnipod.com/en-gb/what-is-omnipod/omnipod-5) (USA e UE). Questi sono molto diversi dai sistemi fai da te, principalmente perché entrambi includono un “algoritmo di apprendimento” che regola la quantità di insulina erogata in base al fabbisogno insulinico dei giorni precedenti. Molte persone nella comunità fai da te hanno già provato questi sistemi commerciali e li hanno confrontati con il loro sistema fai da te. È possibile scoprire di più su come i diversi sistemi si confrontano chiedendo sui gruppi Facebook dedicati per questi sistemi, sul gruppo [AAPS Facebook](https://www.facebook.com/groups/AndroidAPSUsers/) o su [Discord](https://discord.com/invite/4fQUWHZ4Mw).
...
Lo smartphone **Android** avrà anche bisogno di avere un'altra app installata in più di **AAPS**. Questa sarà un'app Dexcom modificata chiamata "crea la tua app Dexcom" [**BYODA**](https://docs.google.com/forms/d/e/1FAIpQLScD76G0Y-BlL4tZljaFkjlwuqhT83QlFM5v6ZEfO7gCU98iJQ/viewform?fbzx=2196386787609383750&fbclid=IwAR2aL8Cps1s6W8apUVK-gOqgGpA-McMPJj9Y8emf_P0-_gAsmJs6QwAY-o0) o [**xDrip+**](https://xdrip.readthedocs.io/en/latest/install/usethedoc/). Questa app aggiuntiva riceve i dati di glucosio da un sensore (**2**) tramite bluetooth, e poi invia i dati internamente sul telefono all'app **AAPS**.
...
Ci sono diverse modalità di monitoraggio possibili (Sugarmate, Dexcom Follow, xDrip+, Android Auto _ecc._) utili ai genitori/assistenti e agli adulti in alcuni scenari (sonno/guida) che necessitano di avvisi personalizzabili. In alcune app (xDrip+) puoi anche disattivare completamente gli allarmi, il quale è di aiuto con un nuovo sensore in fase di stabilizzazione che non vuoi ancora usare per il tuo circuito chiuso.
