...
- [Omnipod Eros](../CompatiblePumps/OmnipodEros.md)  ([dispositivo di comunicazione aggiuntivo](#CompatiblePumps-additional-communication-device) necessario)
...
- Alcuni vecchi [Medtronic](../CompatiblePumps/MedtronicPump.md) ([dispositivo di comunicazione aggiuntivo](#CompatiblePumps-additional-communication-device) necessario)
...
- ![OrangeLink](../images/pump/eros/OrangeLink.png)  [Sito Web OrangeLink](https://getrileylink.org/product/orangelink)
- ![RileyLink](../images/pump/eros/RileyLink.png) [RileyLink 433MHz](https://getrileylink.org/product/rileylink433)
- ![EmaLink](../images/pump/eros/EmaLink.png)  [Sito Web Emalink](https://github.com/sks01/EmaLink) - [Contatti](mailto:getemalink@gmail.com)
- ![DiaLink](../images/pump/eros/DiaLink.png)  DiaLink - [Contatti](mailto:Boshetyn@ukr.net)
- ![LoopLink](../images/pump/eros/LoopLink.png)  [Sito Web LoopLink](https://www.getlooplink.org/) - [Contatti](https://jameswedding.substack.com/) - Non Testato