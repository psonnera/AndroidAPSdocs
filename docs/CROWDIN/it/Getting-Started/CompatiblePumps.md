...
- Alcuni vecchi modelli di [Medtronic](../CompatiblePumps/MedtronicPump.md) ([dispositivo di comunicazione aggiuntivo](#CompatiblePumps-additional-communication-device) necessario)
