...
![dexcom_options](../images/Preparing/AAPS_connectivity_Dex_02.png) ![libre_options](../images/Preparing/AAPSconnectivity_libre.png) ![eversense_options](../images/Preparing/AAPS_connectivity_eversense.png)
...
Samsung has an unfortunate track record of forcing updates of their phones which cause bluetooth connectivity issues. To disable these forced updates you need to switch the phone to "developer mode" by: go to settings and about then software information, then tap build number until it confirms you have unlocked developer mode. Got back to main settings menu and you should see a new developer options menu item. Open developer options and scroll to find auto system update and turn it off
:::
