...
<details>
<summary>version and last change information</summary>
...
![Use system notifications for alerts and notifications](../images/auto/android_auto_02.png)

In **Local Alerts** activate **Use system notifications for alerts and notifications**

![Use system notifications for alerts and notifications](../images/auto/android_auto_03.png)

Please check now that you get notifications from **AAPS** on the phone before you walk to your car!

![Use system notifications for alerts and notifications](../images/auto/android_auto_04.png)
...
![Enable developer mode](../images/auto/android_auto_08.png)

Confirm that you want to enable the developer mode in the modal dialog "Allow development settings?".

![Enable developer mode](../images/auto/android_auto_09.png)

In the **developer settings** enable the "Unknown sources".

![Enable developer mode](../images/auto/android_auto_10.png)
...
![number icon - Android Auto in car](../images/auto/android_auto_11.png)
